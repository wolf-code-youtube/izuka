...
import photo from "../../public/us1.jpg";
import { Link, Navigate } from "react-router-dom";

const QuizGame = () => {

  const question = {
    text: "Which semester is this picture from?",
    options: ["8th sem", "7th sem", "5th sem", "6th sem"],
    correctAnswer: "5th sem",
  };
  ...
  const handleAnswer = (option) => {
    if (option === question.correctAnswer) {
      ...
      setMessage("❌ Expected better from you Izuka :( (refresh maro)");
    }
